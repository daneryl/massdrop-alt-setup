...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC] = LAYOUT(
        KC_GRV,         KC_1,    KC_2,           KC_3, KC_4, KC_5, KC_6,          KC_7, KC_8,           KC_9,   KC_0,              KC_MINS,       KC_EQUAL, KC_BSPC, LSFT(KC_GRV),  \
    ...
    [TMUX] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS,   KC_TRNS,        KC_TRNS,         KC_TRNS, TMUX_THUMBS, KC_TRNS,          KC_TRNS,   KC_TRNS, KC_TRNS,    TMUX_PREV_WINDOW,TMUX_COPY_MODE, KC_TRNS, KC_TRNS,    KC_TRNS, \
    ...
    /*     KC_ESC,  KC_A,    KC_S,    KC_D, KC_F, KC_G, KC_H, KC_J,   KC_K,    KC_L,   KC_SCOLON, KC_QUOTE,      KC_ENT,   KC_PGUP, \ */
    /*     KC_LSPO, KC_Z,    KC_X,    KC_C, KC_V, KC_B, KC_N, KC_M,   KC_COMM, KC_DOT, KC_SLSH,   KC_RSPC,                 KC_UP,   KC_PGDN, \ */
    /*     KC_LCTL, KC_LALT, KC_LGUI,                         KC_SPC,                  KC_RALT,   MO(FUNCTION),  KC_LEFT,  KC_DOWN, KC_RGHT  \ */
    /* ), */
    ...
    [NAV_MAC] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, LALT(KC_RIGHT), KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,             KC_TRNS, \
    ...
    [FUNCTION] = LAYOUT(
        TG(GAMING), KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_MUTE, \
        KC_MNXT,     RGB_SPD, RGB_VAI, RGB_SPI, RGB_HUI, RGB_SAI, _______, U_T_AUTO,U_T_AGCR,_______, KC_PSCR, KC_SLCK, KC_PAUS, _______, KC_END, \
        KC_MPRV,     RGB_RMOD,RGB_VAD, RGB_MOD, RGB_HUD, RGB_SAD, _______, _______, _______, _______, _______, _______,          _______, KC_VOLU, \
  ...
  if (old_layer != new_layer) {
    switch (new_layer) {
      case 0:
        ...
        break;
      case 1:
        rgblight_mode(RGB_MATRIX_EFFECT_MAX-2);
        break;
    }
